...
async function runScraper(searchQueryInput) {
    ...
    try {
        ...
        // Search for the provided query using multiple selector fallbacks for Google Maps
        const searchInputSelector = [
            ...
            'textarea[aria-label="Search Google Maps"]',
        ...
        if (!searchInput) {
            throw new Error('Could not find Google Maps search input. The page structure may have changed.');
        }
